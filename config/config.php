 ...
 */
define("EMAIL_PASSWORDRESET_URL", $domain . "forgot.php");
define("EMAIL_PASSWORDRESET_FROM", "no-reply@" . $brand . ".com");
define("EMAIL_PASSWORDRESET_FROM_NAME", $brand);
define("EMAIL_PASSWORDRESET_SUBJECT", "Password reset for " . $brand);
...
define("EMAIL_PASSWORDRESET_FROM", "no-reply@" . $brand . ".com");
define("EMAIL_PASSWORDRESET_FROM_NAME", $brand);
define("EMAIL_VERIFICATION_SUBJECT", "Account activation for " . $brand);
