<div class="tile" xmlns="http://www.w3.org/1999/html">
    <div class="tile-padding">
        <h3>Products Page
            <button type='submit' class='btn btn-default' data-toggle='modal' data-target='#addNewProduct'><i class='btl bt-shopping-cart'></i> Add new Product</button>
        </h3>
        <?php $siteFunctions->displayCallbackMessage(); ?>
        <p>
            Manage the stock and range of products you offer to your customers.
        </p>
    </div>
    <?php $adminProducts->displayProductsTable(); ?>
</div>
<script>
    $(function(){
        $("table").stupidtable();
